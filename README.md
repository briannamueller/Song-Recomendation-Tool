...
#### Using the Spotify API, I have created the funtion recommend_songs() that allows a user to get song recomendations based on other artists and songs they enjoy.
...
#### Once the user is satisfied with their recommended tracks, they can use the function create_playlist() which takes the dataframe of recomended songs as input and creates a Spotify playlist - All done within Python.
- Funtion requires a user ID which can be found on your Spotify profile page. Select the three dots that appear below your profile picture, select 'Share' and then 'Copy Spotify URI'. 
